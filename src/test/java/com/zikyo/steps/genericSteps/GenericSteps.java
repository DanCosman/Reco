...
//        Form parentForm = new Form(visibleContainer).setTitle("Drivers");
    ...
    public void I_type_into_field_with_input(String value, String label) throws Throwable {
        WebLocator container = new WebLocator().setExcludeClasses();
    ...
    @And("^I click on link with text class \"([^\"]*)\"$")
    public void iClickOnLinkWithTextClass(String arg0) throws Throwable {
        WebLocator link = new WebLocator().setCls("");
        link.click();
    }
}
